...
class AlpacaCandleClient:
    ...
    def recent_hourly(self, symbol: str, end) -> pd.DataFrame:
        ...
        params={"start":(end-pd.to_timedelta(90,unit="D")).isoformat(),"end":end.isoformat(),"timeframe":"1Hour",
        ...
        return frame[["timestamp","symbol","data_provider","open","high","low","close","volume"]].drop_duplicates(["symbol","timestamp"],keep="last").tail(250)
